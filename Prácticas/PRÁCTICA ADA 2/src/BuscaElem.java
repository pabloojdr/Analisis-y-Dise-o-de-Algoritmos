...
public final class BuscaElem {
	...
	public static <T extends Comparable<? super T>> T kesimoRec(T v[], int izq, int der, int k) {
		...
		T ordenada[] = v.clone();
		OrdenacionRapida.ordenar(ordenada);
		// System.out.println("SIN ORDENACIÓN: "+Ordenacion.vectorAString(v));
		// System.out.println("ORDENACIÓN: "+Ordenacion.vectorAString(ordenada));
		return ordenada[k];
	}
